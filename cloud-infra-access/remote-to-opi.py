...
print(f'We are using your private key located at {ssh_key_path} to authenticate; if this does not work make sure Jeff has added the public key from that (generally denoted with a .pub suffix) to the opi server!')
